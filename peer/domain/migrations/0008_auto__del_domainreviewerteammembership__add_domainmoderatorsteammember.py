...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'DomainReviewerTeamMembership'
        db.delete_table(u'domain_domainreviewerteammembership')

        # Adding model 'DomainModeratorsTeamMembership'
        db.create_table(u'domain_domainmoderatorsteammembership', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('domain', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['domain.Domain'])),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='domain_moderator_teams', to=orm['auth.User'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal(u'domain', ['DomainModeratorsTeamMembership'])


    def backwards(self, orm):
        
        # Adding model 'DomainReviewerTeamMembership'
        db.create_table(u'domain_domainreviewerteammembership', (
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='domain_reviewer_teams', to=orm['auth.User'])),
            ('domain', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['domain.Domain'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'domain', ['DomainReviewerTeamMembership'])

        # Deleting model 'DomainModeratorsTeamMembership'
        db.delete_table(u'domain_domainmoderatorsteammembership')
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 12, 13, 26, 49, 754090)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 12, 13, 26, 49, 753799)'}),
